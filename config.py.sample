TOKEN = '7015542991:AAHHBGhrTc1RjkqPjRD6OduGhCyMI2HgeIM'  # Learn how to get one on https://core.telegram.org/bots#6-botfather
ADMIN_ID = 34651378
...
if SET_WEBHOOK:  # Refer to https://core.telegram.org/bots/webhooks to learn how to setup webhook components
    ...
    SERVER_PORT = 80
    SSL_CERT = 'PUBLIC.pem'  # File path of public SSL certificate
    SSL_PRIV = 'PRIVATE.key'  # File path of private key of SSL certificate
